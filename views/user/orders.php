    ...
    <div class="row">
        <div class="col-md-3">
            <div class="list-group">
                ...
                <a href="<?php echo APP_URL; ?>/user/orders.php" class="list-group-item list-group-item-action active">
                    <i class="fas fa-shopping-bag"></i> Đơn hàng
                </a>
                <a href="<?php echo APP_URL; ?>/user/addresses.php" class="list-group-item list-group-item-action">
        ...
        <div class="col-md-9">
            ...
            <?php if (empty($orders)): ?>
                <div class="alert alert-info">
                    Bạn chưa có đơn hàng nào. <a href="<?php echo APP_URL; ?>/products/index.php">Mua sắm ngay</a>
                </div>
            <?php else: ?>
                <?php foreach ($orders as $order): ?>
                    <div class="card mb-3">
                        ...
                        <div class="card-footer">
                            <a href="<?php echo APP_URL; ?>/user/order-detail.php?id=<?php echo $order['order_id']; ?>" class="btn btn-sm btn-primary">
                                Xem chi tiết
                            </a>
                        </div>
                    </div>
